...
function applyMobileCanvasFit(){
    ...
    */
    ...
    /*
-------------------------------------------------------
MOBILE LANDSCAPE → 16:9 ANNOTATION FRAME
-------------------------------------------------------
...
Mobile Landscape:
    annotation is displayed inside a 16:9 frame
-------------------------------------------------------
*/
...
if (
    ...
    /*
    ---------------------------------------------------
    FIXED 16:9 LOGICAL ANNOTATION SIZE
    ---------------------------------------------------
    */

    const landscapeWidth = 1600;
    const landscapeHeight = 900;


    /*
    ---------------------------------------------------
    AVAILABLE MOBILE LANDSCAPE AREA
    ---------------------------------------------------
    */
    ...
    */
    ...
    /*
    ---------------------------------------------------
    APPLY 16:9 MOBILE LANDSCAPE FRAME
    ---------------------------------------------------
    */
    ...
    console.log(
        "ANNOTATION MOBILE LANDSCAPE: 16:9",
        {
            logicalWidth:
                landscapeWidth,
